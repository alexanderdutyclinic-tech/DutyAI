...
$('parseDiagnosis').addEventListener('click',()=>{
  ...
  // Temporary local structuring for the first test.
  // AI parsing will replace this later; the coordinator must confirm it.
  const data = {
...
$('continueToOptions').addEventListener('click',()=>{
  alert('Quotation options are the next module: the coordinator will choose one or more implant/material options.');
});
